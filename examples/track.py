...
def parse_opt():
    ...
    parser.add_argument('--yolo-model', type=Path, default='/mnt/YOLOv8/'
                                                           'yolov8'
                                                           '/weights/best.pt',
                        help='yolo model path')
    parser.add_argument('--reid-model', type=Path, default='/yolo_tracking/WEIGHTS/osnet_x0_25_market.pth',
                        help='reid model path, we donot need')
    parser.add_argument('--tracking-method', type=str, default='piglettrack',
                        help='piglettrack')
    parser.add_argument('--source', type=str, default='D0901.mp4',
    ...
    parser.add_argument('--save-txt', action='store_true',
                        help='save tracking results in a txt file, cut every frame')
    parser.add_argument('--save-id-crops', action='store_true',
                        help='save each crop to its respective id folder')
    parser.add_argument('--save-mot', default=ROOT / 'runs' / 'track', action='store_true',
                        help='save tracking results in a single txt file, save mot result'
                             'video.txt')
